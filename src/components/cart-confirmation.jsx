...
export const CartConfirmation = () => {
  const {isClose, toggleClose} = useCartStore();
  ...
  return (
    <dialog hidden={isClose} className="bg-black/50 w-full  fixed h-screen grid place-content-center">
        <div className="w-[375px] md:w-[600px] py-10 px-6 bg-white rounded-xl">
            <img src="/public/assets/images/icon-order-confirmed.svg" alt="icon-order-confirmed" />
            <h2 className="text-[2.5rem] font-bold">Cart Confirmed</h2>
            ...
            <CartButton onClick={toggleClose} text="Start New Order"/>
        </div>
    </dialog>
  )
}
